...
## [14.0.0](https://github.com/toothpickstirvat/revm/compare/revme-v13.0.0...revme-v14.0.0) - 2026-03-25

### Added

- *(revme)* list all failed tests at the end with --keep-going ([#3491](https://github.com/toothpickstirvat/revm/pull/3491))

### Fixed

- *(revme)* use transact state for debug "State after" output ([#3498](https://github.com/toothpickstirvat/revm/pull/3498))
- *(revme)* guard unconditional println in blockchaintest for --json mode ([#3500](https://github.com/toothpickstirvat/revm/pull/3500))

### Other

- *(revme)* use alloy-trie instead of triehash ([#3488](https://github.com/toothpickstirvat/revm/pull/3488))
