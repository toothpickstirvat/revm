...
## [0.8.0](https://github.com/toothpickstirvat/revm/compare/revme-v0.7.0...revme-v0.8.0) - 2024-07-15

### Added
- *(EOF)* Bytecode::new_raw supports EOF, new_raw_checked added ([#1607](https://github.com/toothpickstirvat/revm/pull/1607))

### Other
- *(GeneralState)* skip fewer specs ([#1603](https://github.com/toothpickstirvat/revm/pull/1603))
