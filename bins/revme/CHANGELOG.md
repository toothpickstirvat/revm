...
## [10.1.0](https://github.com/toothpickstirvat/revm/compare/revme-v10.0.2...revme-v10.1.0) - 2025-12-14

### Added

- DatabaseCommitExt + increment_balances ([#3195](https://github.com/toothpickstirvat/revm/pull/3195))
- sort accounts by address in blockchaintest output ([#3182](https://github.com/toothpickstirvat/revm/pull/3182))

### Fixed

- *(statetest)* use spec-aware blob base fee update fraction ([#3210](https://github.com/toothpickstirvat/revm/pull/3210))
