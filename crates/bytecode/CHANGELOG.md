...
## [9.1.0](https://github.com/toothpickstirvat/revm/compare/revm-bytecode-v9.0.0...revm-bytecode-v9.1.0) - 2026-03-25
...
- make Bytecode Ord consistent with PartialEq and Hash ([#3479](https://github.com/toothpickstirvat/revm/pull/3479))
