...
## [13.0.0](https://github.com/toothpickstirvat/revm/compare/revm-database-v12.0.0...revm-database-v13.0.0) - 2026-03-25
...
- remove no-op background transition merge builder toggle ([#3510](https://github.com/toothpickstirvat/revm/pull/3510))
