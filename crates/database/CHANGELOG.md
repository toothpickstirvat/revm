...
## [10.0.0](https://github.com/toothpickstirvat/revm/compare/revm-database-v9.0.6...revm-database-v10.0.0) - 2025-12-14

### Added

- DatabaseCommitExt::drain_balances ([#3205](https://github.com/toothpickstirvat/revm/pull/3205))
- DatabaseCommitExt + increment_balances ([#3195](https://github.com/toothpickstirvat/revm/pull/3195))
- DatabaseCommit::commit_iter ([#3197](https://github.com/toothpickstirvat/revm/pull/3197))
- Restrict Database::Error. JournaledAccountTr ([#3199](https://github.com/toothpickstirvat/revm/pull/3199))

### Other

- optimize vector initialization with size hints in state and precompile modules ([#3191](https://github.com/toothpickstirvat/revm/pull/3191))
