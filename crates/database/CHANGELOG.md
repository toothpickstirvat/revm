...
## [16.0.0](https://github.com/toothpickstirvat/revm/compare/revm-database-v15.0.2...revm-database-v16.0.0) - 2026-06-05

### Added

- *(database)* add conditional bundle update builder ([#3729](https://github.com/toothpickstirvat/revm/pull/3729))

### Other

- avoid reallocations and cloning during commit ([#3732](https://github.com/toothpickstirvat/revm/pull/3732))
