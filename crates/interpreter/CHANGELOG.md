...
## [7.1.0](https://github.com/toothpickstirvat/revm/compare/revm-interpreter-v7.0.0...revm-interpreter-v7.1.0) - 2024-07-15

### Added
- use `kzg-rs` for kzg point evaluation ([#1558](https://github.com/toothpickstirvat/revm/pull/1558))

### Fixed
- *(EOF)* MIN_CALLEE_GAS light failure, static-mode check ([#1599](https://github.com/toothpickstirvat/revm/pull/1599))
