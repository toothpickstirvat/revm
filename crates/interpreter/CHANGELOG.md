...
## [2.0.0](https://github.com/toothpickstirvat/revm/compare/revm-interpreter-v1.3.0...revm-interpreter-v2.0.0) - 2024-01-24
...
### Fixed
- *(Interpreter)* is_revert should call is_revert ([#1007](https://github.com/toothpickstirvat/revm/pull/1007))
...
- expose InstructionResult getters in Interpreter result ([#1002](https://github.com/toothpickstirvat/revm/pull/1002))
