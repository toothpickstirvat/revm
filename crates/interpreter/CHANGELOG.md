...
## [6.0.0](https://github.com/toothpickstirvat/revm/compare/revm-interpreter-v5.0.0...revm-interpreter-v6.0.0) - 2024-05-23

### Added
- adjust gas-costs for EIP-2935 BLOCKHASH ([#1422](https://github.com/toothpickstirvat/revm/pull/1422))
- add Opcode::modifies_memory back ([#1421](https://github.com/toothpickstirvat/revm/pull/1421))
- *(EOF)* Add CALLF/JUMPF stack checks ([#1417](https://github.com/toothpickstirvat/revm/pull/1417))
- *(EOF)* remove TXCREATE ([#1415](https://github.com/toothpickstirvat/revm/pull/1415))

### Fixed
- *(interpreter)* avoid overflow when checking if mem limit reached ([#1429](https://github.com/toothpickstirvat/revm/pull/1429))
- blockchash for devnet-0  ([#1427](https://github.com/toothpickstirvat/revm/pull/1427))
...
- *(EOF)* rename extcall opcode/names ([#1416](https://github.com/toothpickstirvat/revm/pull/1416))
- point to gas! in Gas::record_cost ([#1413](https://github.com/toothpickstirvat/revm/pull/1413))
- pop_address should use crate scope ([#1410](https://github.com/toothpickstirvat/revm/pull/1410))
- Remove Host constrain from calc_call_gas ([#1409](https://github.com/toothpickstirvat/revm/pull/1409))
