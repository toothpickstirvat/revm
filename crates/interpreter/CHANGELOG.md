...
## [6.0.1](https://github.com/toothpickstirvat/revm/compare/revm-interpreter-v6.0.0...revm-interpreter-v6.0.1) - 2024-06-27

### Other
- use const blocks ([#1522](https://github.com/toothpickstirvat/revm/pull/1522))
- fix compile for alloydb ([#1559](https://github.com/toothpickstirvat/revm/pull/1559))
- replace AccessList with alloy version ([#1552](https://github.com/toothpickstirvat/revm/pull/1552))
- replace U256 with u64 in BLOCKHASH ([#1505](https://github.com/toothpickstirvat/revm/pull/1505))
