...
## [31.0.1](https://github.com/toothpickstirvat/revm/compare/revm-precompile-v31.0.0...revm-precompile-v31.0.1) - 2025-12-14

### Other

- optimize vector initialization using size hints ([#3200](https://github.com/toothpickstirvat/revm/pull/3200))
- optimize precompile `extend()` ([#3192](https://github.com/toothpickstirvat/revm/pull/3192))
