...
## [17.0.0](https://github.com/toothpickstirvat/revm/compare/revm-precompile-v16.0.0...revm-precompile-v17.0.0) - 2025-01-10
...
- fix some typos (#1800)
- Replace `PrecompileError` variant ([#1797](https://github.com/toothpickstirvat/revm/pull/1797))
...
- modexp gas check ([#737](https://github.com/toothpickstirvat/revm/pull/737))
