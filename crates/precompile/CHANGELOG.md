...
## [8.0.0](https://github.com/toothpickstirvat/revm/compare/revm-precompile-v7.0.0...revm-precompile-v8.0.0) - 2024-05-23

### Fixed
- *(precompile)* ignore infinity points in G1 MSM ([#1432](https://github.com/toothpickstirvat/revm/pull/1432))
- *(precompile)* BLS G2 MSM ([#1428](https://github.com/toothpickstirvat/revm/pull/1428))
