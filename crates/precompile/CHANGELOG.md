...
## [9.1.0](https://github.com/toothpickstirvat/revm/compare/revm-precompile-v9.0.0...revm-precompile-v9.1.0) - 2024-07-15

### Added
- use `kzg-rs` for kzg point evaluation ([#1558](https://github.com/toothpickstirvat/revm/pull/1558))

### Other
- main CHANGELOG ([#1592](https://github.com/toothpickstirvat/revm/pull/1592))
