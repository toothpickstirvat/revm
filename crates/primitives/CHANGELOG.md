...
## [16.0.0](https://github.com/toothpickstirvat/revm/compare/revm-primitives-v15.1.0...revm-primitives-v16.0.0) - 2025-01-10
...
- Implement `with_chain_id` for `CfgEnv` ([#1327](https://github.com/toothpickstirvat/revm/pull/1327))
- *(interpreter)* remove EOF branch in CODE{SIZE,COPY} (#1308)
- Update documentation ([#1275](https://github.com/toothpickstirvat/revm/pull/1275))
- release (#1231)
...
- document when InvalidTransaction errors are thrown ([#722](https://github.com/toothpickstirvat/revm/pull/722))
...
- Small doc comment fix ([#698](https://github.com/toothpickstirvat/revm/pull/698))
...
- Fix typo in primitives/src/state.rs ([#474](https://github.com/toothpickstirvat/revm/pull/474))
...
- Comment Fix ([#430](https://github.com/toothpickstirvat/revm/pull/430))
- *(deps)* bump arbitrary from 1.2.3 to 1.3.0 (#428)
- enabled primtive default feature in precompile (#409)
- Update readmdoc of `perf_analyse_created_bytecodes` ([#404](https://github.com/toothpickstirvat/revm/pull/404))
...
- Add B160/B256 From primitive_types traits ([#380](https://github.com/toothpickstirvat/revm/pull/380))
...
- nits and num of cargo keyword to 5 ([#351](https://github.com/toothpickstirvat/revm/pull/351))
...
- expose hashbrown::HashMap in primitives ([#345](https://github.com/toothpickstirvat/revm/pull/345))
