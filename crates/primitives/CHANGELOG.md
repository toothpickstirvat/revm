...
## [7.0.0](https://github.com/toothpickstirvat/revm/compare/revm-primitives-v6.0.0...revm-primitives-v7.0.0) - 2024-07-15
...
- missing kzg_settings if kzg-rs feature enabled ([#1601](https://github.com/toothpickstirvat/revm/pull/1601))

### Other
- group optimism invalid txn errors ([#1604](https://github.com/toothpickstirvat/revm/pull/1604))
- *(deps)* bump bitflags from 2.5.0 to 2.6.0 ([#1583](https://github.com/toothpickstirvat/revm/pull/1583))
