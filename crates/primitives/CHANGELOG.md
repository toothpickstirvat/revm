...
## [5.1.0](https://github.com/toothpickstirvat/revm/compare/revm-primitives-v5.0.0...revm-primitives-v5.1.0) - 2024-06-27

### Added
- add helper function to mape EVMError's Database error variant ([#1567](https://github.com/toothpickstirvat/revm/pull/1567))
