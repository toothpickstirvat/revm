...
## [5.0.0](https://github.com/toothpickstirvat/revm/compare/revm-primitives-v4.0.0...revm-primitives-v5.0.0) - 2024-05-23
...
### Fixed
- *(primitives)* specify the optimism cfg on spec_to_generic ([#1412](https://github.com/toothpickstirvat/revm/pull/1412))
