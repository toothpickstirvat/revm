...
## [20.0.0](https://github.com/toothpickstirvat/revm/compare/revm-v19.2.0...revm-v20.0.0) - 2025-01-10
...
- fix eip3155 summary gas_used bug and add fork name ([#1216](https://github.com/toothpickstirvat/revm/pull/1216))
...
- fix EthersDB deadlock ([#1089](https://github.com/toothpickstirvat/revm/pull/1089))
...
- fix previous commit ([#1044](https://github.com/toothpickstirvat/revm/pull/1044))
...
- fix typos in revm crate ([#821](https://github.com/toothpickstirvat/revm/pull/821))
...
- fix revert from DestroyedChanged to DestroyedAgain ([#648](https://github.com/toothpickstirvat/revm/pull/648))
...
- fix comment ([#529](https://github.com/toothpickstirvat/revm/pull/529))
...
- fix web3db sanity check ([#245](https://github.com/toothpickstirvat/revm/pull/245))
...
- Test l1 gas used fjord ([#1749](https://github.com/toothpickstirvat/revm/pull/1749))
- Add test for `revm::optimism::L1BlockInfo::calculate_tx_l1_cost_fjord` ([#1743](https://github.com/toothpickstirvat/revm/pull/1743))
...
- release (#1683)
- Add OP-Granite hardfork, limiting bn256Pairing input size ([#1685](https://github.com/toothpickstirvat/revm/pull/1685))
...
- Use HandleOrRuntime to allow alloydb/ethersdb to hold a custom runtime ([#1576](https://github.com/toothpickstirvat/revm/pull/1576))
...
- Removed .clone() in ExecutionHandler::call, and reusing output buffer in Interpreter ([#1512](https://github.com/toothpickstirvat/revm/pull/1512))
...
- remove 'checked' bytecode bench causing benchmarks to crash due to name ([#1461](https://github.com/toothpickstirvat/revm/pull/1461))
- cargo update (#1451)
- cleanup host blockhash fn (#1430)
- Revert "Revert "feat: implement EIP-2935 ([#1354](https://github.com/toothpickstirvat/revm/pull/1354))" ([#1424](https://github.com/toothpickstirvat/revm/pull/1424))" ([#1426](https://github.com/toothpickstirvat/revm/pull/1426))
- Revert "feat: implement EIP-2935 ([#1354](https://github.com/toothpickstirvat/revm/pull/1354))" ([#1424](https://github.com/toothpickstirvat/revm/pull/1424))
- *(deps)* bump anyhow from 1.0.82 to 1.0.83 (#1404)
- remove alloydb example as the crate is not published (#1398)
- release (#1261)
- refactor lints (#1386)
- bump alloy & specify dep rev ([#1380](https://github.com/toothpickstirvat/revm/pull/1380))
...
- Improve `EthersDB` ([#1208](https://github.com/toothpickstirvat/revm/pull/1208))
- Revert "feat: optional nonce check ([#1195](https://github.com/toothpickstirvat/revm/pull/1195))" ([#1212](https://github.com/toothpickstirvat/revm/pull/1212))
- release (#1175)
- Change unwrap to ? to propagate errors ([#1207](https://github.com/toothpickstirvat/revm/pull/1207))
- fix wonky test (#1197)
- clippy (#1196)
...
- Check runtime dynamically ([#1135](https://github.com/toothpickstirvat/revm/pull/1135))
- *(deps)* bump auto_impl from 1.1.2 to 1.2.0 (#1132)
- Add `db` and `db_mut` to evm ([#1133](https://github.com/toothpickstirvat/revm/pull/1133))
- add ToString for no_std add exports some types in no_std (#1128)
- Add `clone` method to `ContextWithHandlerCfg` ([#1127](https://github.com/toothpickstirvat/revm/pull/1127))
- remove unused EvmInstructionTables type alias (#1123)
- release tag v30 revm v6.1.0 (#1100)
- Ensure `L1Block` is in the cache ([#1121](https://github.com/toothpickstirvat/revm/pull/1121))
- Fix feature name for generate_block_traces example ([#1120](https://github.com/toothpickstirvat/revm/pull/1120))
- *(refactor)* Propagate fatal error (#1116)
- Revert "fix EthersDB deadlock ([#1089](https://github.com/toothpickstirvat/revm/pull/1089))" ([#1118](https://github.com/toothpickstirvat/revm/pull/1118))
- Remove DatabaseRef bound on CacheDB ([#1113](https://github.com/toothpickstirvat/revm/pull/1113))
- clippy cleanup (#1112)
...
- Add memory offset ([#1032](https://github.com/toothpickstirvat/revm/pull/1032))
...
- Remove preserve_order in serde_json ([#997](https://github.com/toothpickstirvat/revm/pull/997))
...
- set deduct_caller in optimism handler ([#988](https://github.com/toothpickstirvat/revm/pull/988))
...
- getter for  field of ([#792](https://github.com/toothpickstirvat/revm/pull/792))
...
- Improve wording and fix typos ([#749](https://github.com/toothpickstirvat/revm/pull/749))
...
- make BundleBuilder publicly available ([#729](https://github.com/toothpickstirvat/revm/pull/729))
...
- bundle size hint ([#670](https://github.com/toothpickstirvat/revm/pull/670))
- deprecate `RefDBWrapper` (#696)
- expose StateDBBox (#694)
- *(state)* Make Database more generic. (#687)
- nits and renamings (#684)
- apply builder pattern for BundleState initialization ([#649](https://github.com/toothpickstirvat/revm/pull/649))
- impl Eq, PartialEq for TransitionState (#677)
- Removed the last dependencies breaking no-std build. ([#669](https://github.com/toothpickstirvat/revm/pull/669))
...
- add value parameter to Inspector::selfdestruct ([#645](https://github.com/toothpickstirvat/revm/pull/645))
...
- book workflow ([#537](https://github.com/toothpickstirvat/revm/pull/537))
...
- consume all gas on invalid opcode ([#500](https://github.com/toothpickstirvat/revm/pull/500))
...
- add example to revm crate ([#468](https://github.com/toothpickstirvat/revm/pull/468))
...
- bump all
- ethers to v2.0
- Improve EthersDB::new ([#440](https://github.com/toothpickstirvat/revm/pull/440))
- add feature for ignoring base fee check ([#436](https://github.com/toothpickstirvat/revm/pull/436))
...
- impl NonceTooHigh/ NonceTooLow checks ([#383](https://github.com/toothpickstirvat/revm/pull/383))
- fix compilation if serde not enabled (#381)
- add no_std to primitives ([#366](https://github.com/toothpickstirvat/revm/pull/366))
...
- Use gas price in place of effective gas price for initial balance check ([#359](https://github.com/toothpickstirvat/revm/pull/359))
...
- make load_account pub ([#325](https://github.com/toothpickstirvat/revm/pull/325))
...
- remove --all-features from tests bcs of gas calc gets disabled ([#291](https://github.com/toothpickstirvat/revm/pull/291))
...
- Bump revm to v2.3.0
- disable gas refunds with env flag ([#267](https://github.com/toothpickstirvat/revm/pull/267))
- Export StorageSlot ([#265](https://github.com/toothpickstirvat/revm/pull/265))
- Remove unused parking_lot dependency ([#244](https://github.com/toothpickstirvat/revm/pull/244))
...
- Borrow self and add derive traits for OpCode ([#231](https://github.com/toothpickstirvat/revm/pull/231))
...
- Optimize gas calculation U256 to u64 ([#213](https://github.com/toothpickstirvat/revm/pull/213))
- current_opcode fn and rename program_counter to instruction_pointer ([#211](https://github.com/toothpickstirvat/revm/pull/211))
...
- use Infallible for memory db's error type ([#196](https://github.com/toothpickstirvat/revm/pull/196))
- reexport revm_precompiles as precompiles ([#197](https://github.com/toothpickstirvat/revm/pull/197))
- Cache precompile hashmaps ([#192](https://github.com/toothpickstirvat/revm/pull/192))
- Add support for old forks. ([#191](https://github.com/toothpickstirvat/revm/pull/191))
- export JournaledState (#190)
- Revert "refactor(revm): use u64 for gas refund counter ([#180](https://github.com/toothpickstirvat/revm/pull/180))" ([#187](https://github.com/toothpickstirvat/revm/pull/187))
- *(revm)* use u64 for gas refund counter (#180)
- *(precompiles)* Vec -> BTreeMap (#177)
- *(deps)* bump futures from 0.3.21 to 0.3.23 (#173)
- Handle HighNonce tests ([#176](https://github.com/toothpickstirvat/revm/pull/176))
- JournaledState ([#175](https://github.com/toothpickstirvat/revm/pull/175))
- Update account storage methods in CacheDB (#171)
- Return `ExecutionResult`, which includes `gas_refunded` (#169)
- Optimize calldataload. Some cleanup ([#168](https://github.com/toothpickstirvat/revm/pull/168))
- bump revm v1.9.0
...
- bump revm to v1.7.0
- Byzantine to Byzantium ([#146](https://github.com/toothpickstirvat/revm/pull/146))
- Make CacheDB fields pub ([#145](https://github.com/toothpickstirvat/revm/pull/145))
- Update README
- bump revm 1.6.0, changelogs
- Introduce account Touched/Cleared/None state in CacheDB ([#140](https://github.com/toothpickstirvat/revm/pull/140))
- Return specific `Return` statuses in `CALL`s ([#136](https://github.com/toothpickstirvat/revm/pull/136))
- don't delete account and storage entries on commit ([#126](https://github.com/toothpickstirvat/revm/pull/126))
- revm bump v1.5.0. Release notes
- enable EIP2200 in Istanbul ([#125](https://github.com/toothpickstirvat/revm/pull/125))
- Consensus error with gas block for SSTORE stipend check ([#124](https://github.com/toothpickstirvat/revm/pull/124))
- v9 release notes
...
- empty keccak constant and remove access_list.clone ([#111](https://github.com/toothpickstirvat/revm/pull/111))
- typo fixes
- [revm] is_static for Inspector initialize_interp
- v6 changelog, bump versions
- add missing derives
- Rework analysis ([#89](https://github.com/toothpickstirvat/revm/pull/89))
- Update AccountInfo#code documentation ([#94](https://github.com/toothpickstirvat/revm/pull/94))
- Various fixes ([#93](https://github.com/toothpickstirvat/revm/pull/93))
- remove untable fmt
- nit
- [revm] optimize is_push check
- turn off default features for zkp-u256 (#68)
- Bump futures from 0.3.17 to 0.3.21 ([#64](https://github.com/toothpickstirvat/revm/pull/64))
- bump dependencies ([#63](https://github.com/toothpickstirvat/revm/pull/63))
...
- [revm][perf] Error refactor to Return ([#9](https://github.com/toothpickstirvat/revm/pull/9))
