...
## [4.0.0](https://github.com/toothpickstirvat/revm/compare/revm-v3.5.0...revm-v4.0.0) - 2024-01-24

### Added
- *(inspector)* Share call/create inputs in Inspector call_end/create_end ([#1003](https://github.com/toothpickstirvat/revm/pull/1003))
...
- *(ethersdb)* propagate errors instead of panicking in basic_ref ([#935](https://github.com/toothpickstirvat/revm/pull/935))
- *(revm)* implement prepend_state for BundleState ([#907](https://github.com/toothpickstirvat/revm/pull/907))
- add serde derives for `CacheDB` under "serde" flag ([#911](https://github.com/toothpickstirvat/revm/pull/911))
- *(examples)* generate block traces ([#895](https://github.com/toothpickstirvat/revm/pull/895))
- *(revm)* Evm Context Tests and test-utils Feature ([#903](https://github.com/toothpickstirvat/revm/pull/903))
...
- *(revm)* implement DatabaseRef trait for EthersDB ([#774](https://github.com/toothpickstirvat/revm/pull/774))

### Fixed
- optimism gas refunds ([#989](https://github.com/toothpickstirvat/revm/pull/989))
...
- Optimism execution ([#789](https://github.com/toothpickstirvat/revm/pull/789))
- rename `DatabaseRef` trait functions to `*_ref` ([#795](https://github.com/toothpickstirvat/revm/pull/795))

### Other
- *(Inspector)* Add return_memory_offset to Inspector::call ([#1006](https://github.com/toothpickstirvat/revm/pull/1006))
- update call end docs ([#1000](https://github.com/toothpickstirvat/revm/pull/1000))
- add getter for specId ([#998](https://github.com/toothpickstirvat/revm/pull/998))
- Remove preserve_order in serde_json ([#997](https://github.com/toothpickstirvat/revm/pull/997))
- update create docs ([#999](https://github.com/toothpickstirvat/revm/pull/999))
...
- *(EvmBuilder)* Remove unnecessary BuilderStage trait ([#979](https://github.com/toothpickstirvat/revm/pull/979))
...
- *(deps)* bump anyhow from 1.0.77 to 1.0.79 ([#950](https://github.com/toothpickstirvat/revm/pull/950))
- relax Bytes requirement and use slice instead ([#937](https://github.com/toothpickstirvat/revm/pull/937))
- *(deps)* bump futures from 0.3.29 to 0.3.30 ([#927](https://github.com/toothpickstirvat/revm/pull/927))
- *(deps)* bump anyhow from 1.0.75 to 1.0.76 ([#921](https://github.com/toothpickstirvat/revm/pull/921))
- *(deps)* bump tokio from 1.34.0 to 1.35.0 ([#909](https://github.com/toothpickstirvat/revm/pull/909))
- *(revm)* leverage StorageSlot methods, where appropriate ([#899](https://github.com/toothpickstirvat/revm/pull/899))
- relax state generic ([#881](https://github.com/toothpickstirvat/revm/pull/881))
- clippy ([#877](https://github.com/toothpickstirvat/revm/pull/877))
- *(deps)* bump ethers-contract from 2.0.10 to 2.0.11 ([#867](https://github.com/toothpickstirvat/revm/pull/867))
...
- *(deps)* bump tokio from 1.33.0 to 1.34.0 ([#856](https://github.com/toothpickstirvat/revm/pull/856))
- change addresses to iterator and add into_addresses ([#855](https://github.com/toothpickstirvat/revm/pull/855))
- use keccak256 for blockhash ([#854](https://github.com/toothpickstirvat/revm/pull/854))
- review safety comments ([#811](https://github.com/toothpickstirvat/revm/pull/811))
- *(deps)* bump futures from 0.3.28 to 0.3.29 ([#839](https://github.com/toothpickstirvat/revm/pull/839))
- *(state)* consistent selfdestruct status transition ([#847](https://github.com/toothpickstirvat/revm/pull/847))
- *(state)* move account status transitions to `AccountStatus` ([#844](https://github.com/toothpickstirvat/revm/pull/844))
- *(state)* simplify control flow in `CacheState::apply_evm_state` ([#842](https://github.com/toothpickstirvat/revm/pull/842))
- Refactor precompile list from Hash to vec ([#823](https://github.com/toothpickstirvat/revm/pull/823))
- *(state)* make `State::apply_transition` pub ([#832](https://github.com/toothpickstirvat/revm/pull/832))
- *(state)* make bundle state non-optional ([#828](https://github.com/toothpickstirvat/revm/pull/828))
- Refactor evm data to its file ([#815](https://github.com/toothpickstirvat/revm/pull/815))
...
- remove `step` and `step_end` return result ([#804](https://github.com/toothpickstirvat/revm/pull/804))
...
- *(deps)* bump tokio from 1.32.0 to 1.33.0 ([#785](https://github.com/toothpickstirvat/revm/pull/785))
- Use upstream create and create2 implementations ([#775](https://github.com/toothpickstirvat/revm/pull/775))
- reorder JournalState impl ([#772](https://github.com/toothpickstirvat/revm/pull/772))
