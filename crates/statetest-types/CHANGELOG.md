...
## [16.0.1](https://github.com/toothpickstirvat/revm/compare/revm-statetest-types-v16.0.0...revm-statetest-types-v16.0.1) - 2026-03-25

### Other

- remove unused bytecode dependency from revm-statetest-types ([#3485](https://github.com/toothpickstirvat/revm/pull/3485))
